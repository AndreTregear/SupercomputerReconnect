...
[ -f "$SCRIPT_DIR/hpc-setup" ] && install -m 755 "$SCRIPT_DIR/hpc-setup" "$BIN_DIR/hpc-setup"
[ -f "$SCRIPT_DIR/hpc-job" ] && install -m 755 "$SCRIPT_DIR/hpc-job" "$BIN_DIR/hpc-job"
[ -f "$SCRIPT_DIR/hipergator-presets.sh" ] && install -m 644 "$SCRIPT_DIR/hipergator-presets.sh" "$SHARE_DIR/hipergator-presets.sh"

echo ""
echo "Installed:"
echo "  $BIN_DIR/hpc-node"
echo "  $BIN_DIR/hpc-reconnect"
echo "  $BIN_DIR/hpc-job"
echo "  $BIN_DIR/hpc-setup"
echo "  $BIN_DIR/hpc-tunnel-forward.sh"
echo "  $SHARE_DIR/eduvpn-auth.js"
echo "  $SHARE_DIR/hipergator-presets.sh"
